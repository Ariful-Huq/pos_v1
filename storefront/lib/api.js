 ...
 * customer token from localStorage when present. No X-Active-Branch header
 * here — the storefront is single-branch fulfillment by design (§1 of the
 * ecommerce SSOT), the backend resolves the branch server-side.
 */
