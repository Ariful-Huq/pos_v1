  ...
  return (
    <footer className="border-t border-gray-200 dark:border-gray-800 mt-16">
      <div className="max-w-6xl mx-auto px-6 py-10 grid grid-cols-1 sm:grid-cols-3 gap-8">
        <div>
          <p className="font-heading text-lg font-semibold text-brand-700 dark:text-brand-500 mb-2">{t("site_name")}</p>
      ...
      <div className="border-t border-gray-200 dark:border-gray-800">
	    <div className="max-w-6xl mx-auto px-6 py-4 text-xs text-gray-400 flex flex-wrap gap-4 justify-between">
